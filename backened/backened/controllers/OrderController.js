import DeliveryAssignment from "../models/dileveryAssingmentModel.js"
...
export const getCurrentOrder = async (req, res) => {
  try {
    ...
    // ✅ Return null instead of 400 when no active order
    if (!assignment) {
    ...
    if (!shopOrder) {
      return res.status(200).json(null)  // ✅ same here
    }
    ...
    // ✅ Also added missing error response (was empty before!)
  }
}
